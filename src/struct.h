...
//the size of each cell is automatically adjusted to fill the window if possible (may not be possible if the maze is too large)
//the program will stop when the user closes the window, press ESCAPE or ENTER
