...
// Renvoie la valeur du tableau visited du voisin de la cellule x y dans la direction dir
...
{
    // On renvoie la valeur du tableau visited en fonction de la direction donnée
    switch (dir)
    {
    case DROITE:
