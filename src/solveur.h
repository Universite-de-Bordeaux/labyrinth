...
// maze : the maze
// deep search (more memory efficient and faster than breadth search in average )
bool has_exit_seeker(maze_t maze);

// return true if the maze is connexe, false otherwise
// maze : the maze
// deep search
bool is_connexe_inspector(maze_t maze);

// return true if the maze is perfect, false otherwise
// maze : the maze
bool is_perfect_inspector(maze_t maze);
...
// return -1 in case of error, 1 otherwise
// maze : the maze
int show_has_exit_seeker(maze_t maze);

// function to visualize the maze and the progression of the solver
// return -1 in case of error, 1 otherwise
// maze : the maze
int show_is_connexe_inspector(maze_t maze);

// function to visualize the maze and the progression of the solver
// return -1 in case of error, 1 otherwise
// maze : the maze
int show_is_perfect_inspector(maze_t maze);

// function to visualize the maze and the progression of the solver
// return -1 in case of error, 1 otherwise
// maze : the maze
int show_best_exit_seeker(maze_t maze);
